...
if (isset($_POST['email'])) {
    ...
    $country = $_POST['countries']; // not required

    $tester_client = $_POST['tester_client']; // required
    ...
    $email_message .= "Tester/Client: " . clean_string($tester_client) . "\n";
